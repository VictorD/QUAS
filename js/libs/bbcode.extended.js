...
(function() {
  ...
  /* ------------------------------ START: CUSTOM LTU CAMPUS MAP TAGS ------------------------------ */

  RoomTag = (function(_super) {
    __extends(RoomTag, _super);

    function RoomTag() {
     RoomTag.__super__.constructor.apply(this, arguments);
    }

    RoomTag.prototype._toHTML = function() {
     return ['<a href="http://www.ltu.se/maps/campusmap/?r=', this.getContent(), '">', this.getContent(), '</a>'];
    };
  ...
  /* ------------------------------ STOP: CUSTOM LTU CAMPUS MAP TAGS ------------------------------ */
